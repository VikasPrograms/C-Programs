// Problem statement : Accept number form user and check whether it is divisible by 3 or 5
// method 1 : For boolean method or using scanf function , using if else loop
